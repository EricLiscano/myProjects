 ...
 function popup(e) {
    ...
    if (!firstLatLng) {
      firstLatLng = e.latlng;
        L.marker(firstLatLng).addTo(mapa).bindPopup('Point A<br/>' + e.latlng).openPopup();
    } else {
      secondLatLng = e.latlng;
        L.marker(secondLatLng).addTo(mapa).bindPopup('Point B<br/>' + e.latlng).openPopup();
    }
...
function medirDistancia() {
    ...
    var distance = mapa.distance(firstLatLng, secondLatLng);
